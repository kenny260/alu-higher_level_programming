...
class Square(Rectangle):
    ...
    # The __str__ and __repr__ methods are intentionally not overridden here
    # to match the output requirement of "[Rectangle] <width>/<height>"
    # when a Square object is printed, as per the 10-main.py example.
    # The area() method is inherited directly from Rectangle and works correctly.
